...
INSERT INTO `proyectos` (
    `id`, `duracion`, `fecha_fin`, `fecha_inicio`, `fecha_registro`, `nombre_proyecto`, 
    `presupuesto`, `cliente`, `certificaciones_requeridas_id`, `entregables_id`, 
    `experiencia_requerida_id`, `facturacion_anual_id`, `fortaleza_tecnologica_id`, 
    `idiomas_id`, `lugar_trabajo_id`, `numero_perfiles_requeridos`, `precio_hora_id`, 
    `solvencia_economica_empresa`, `titulaciones_empleados_id`, `volumetria_id`, 
    `porcentaje_exito`
) VALUES
(1, 12, '2024-12-31', '2024-01-01', '2024-12-02 13:31:24.000000', 'Proyecto de Ejemplo', 
100000, NULL, 1, 2, 1, 2, 3, 1, 2, 3, 1, 'Solvencia económica empresa A', 2, 1, 80.5);
